...
fn square(point: Point, side: f32) -> Rectangle {
    ...
    Rectangle {
        top_left: Point { x: point.x - half_side, y: point.y - half_side },
        bottom_right: Point { x: point.x + half_side, y: point.y + half_side },
    }
}
...
fn main() {
    ...
    println!("area of rectangle is {}", rect_area(&rect2));
    println!("area of square is {}", rect_area(&square));
